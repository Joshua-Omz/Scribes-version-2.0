...
type PostEngagementScore struct {
	PostID          uuid.UUID   `json:"post_id"`
	AmenCount       int64       `json:"amen_count"`
	InsightfulCount int64       `json:"insightful_count"`
	TpCount         int64       `json:"tp_count"`
	AgeDays         interface{} `json:"age_days"`
	AmenRatio       int32       `json:"amen_ratio"`
	InsightfulRatio int32       `json:"insightful_ratio"`
	TpRatio         int32       `json:"tp_ratio"`
	OverallRatio    int32       `json:"overall_ratio"`
}
