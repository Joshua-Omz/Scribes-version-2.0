...
type Repository interface {
	SearchPostsHybrid(ctx context.Context, keywordQuery string, semanticVector interface{}, limit, offset int32) ([]generated.SearchPostsHybridRow, error)
...
func (r *repository) SearchPostsHybrid(ctx context.Context, keywordQuery string, semanticVector interface{}, limit, offset int32) ([]generated.SearchPostsHybridRow, error) {
