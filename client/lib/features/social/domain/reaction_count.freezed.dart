...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReactionCount&&(identical(other.type, type) || other.type == type)&&(identical(other.count, count) || other.count == count));
}
...
@override
String toString() {
  return 'ReactionCount(type: $type, count: $count)';
}
...
class _ReactionCount implements ReactionCount {
  const _ReactionCount({required this.type, required this.count});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ReactionCount&&(identical(other.type, type) || other.type == type)&&(identical(other.count, count) || other.count == count));
}
