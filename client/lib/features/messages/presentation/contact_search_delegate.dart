...
class ContactSearchDelegate extends SearchDelegate<Contact?> {
  ...
  ContactSearchDelegate(this.ref)
    : super(
  ...
  ThemeData appBarTheme(BuildContext context) {
    ...
    return ThemeData(
      appBarTheme: AppBarTheme(
        ...
        titleTextStyle: ScribesTextStyles.bodyMd.copyWith(
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              leading: ScribesAvatar(
                ...
                imageUrl:
                    null, // the SearchContacts query doesn't currently return avatarUrl, but it could be added in the backend
                radius: 20,
              ),
              title: Text(
                contact.displayName,
              ...
              onTap: () async {
                try {
                  ...
                  final conv = await repo.getOrCreateDirectConversation(
                    contact.id,
                  );
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        'Failed to start conversation. Are you offline?',
                      ),
                    ),
                  );
                }
