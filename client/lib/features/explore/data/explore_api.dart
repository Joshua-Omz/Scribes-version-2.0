...
class ExploreApi {
  ...
  Future<Map<String, dynamic>> getExplore({
    ...
    final response = await _dio.get('/explore', queryParameters: queryParams);
  ...
  Future<Map<String, dynamic>> getRecommendations({
    ...
    final queryParams = <String, dynamic>{'sort': sortType, 'limit': limit};
    if (cursor != null) {
      queryParams['offset'] =
          cursor; // Using offset as cursor for simplicity if that's how the backend is doing it
    }
