          ...
          child: Column(
            ...
            children: [
              ...
              const ScribesPostCard(
                ...
                bodyExcerpt: 'Grace is not just a free gift, it is the fundamental reality of the universe...',
                scriptureRef: 'Ephesians 2:8',
                amenCount: 42,
                insightCount: 12,
                thoughtCount: 5,
                isFeatured: true,
                caption: 'Reflections on my morning reading.',
                sermonSource: 'Sunday Service at Grace Church',
                isCorrection: true,
                // publishedAt is optional, leaving null or hardcoding:
